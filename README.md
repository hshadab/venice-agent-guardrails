...
[1] Venice E2EE inference
    ...
    Nonce match:      true
    Plan:             {"tool":"send_email","recipient":"alice@partner-corp.com",...}
...
[3] Gate
    ...
    Attach proof_id=prf_01H... to your audit log.
```
...
| ICME three-solver check | **Real** — `POST /v1/checkIt` runs Z3, AR, and LLM; returns real `zk_proof_id`. |
